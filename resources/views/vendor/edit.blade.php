...
<div class="container-fluid">
    <h4 class="page-title"><i class="fas fa-pen-to-square me-2 text-primary"></i> Edit Data Vendor</h4>

    <div class="form-container text-start">
        <form method="POST" action="{{ route('vendor.update', $s->kd_vendor) }}">
            @csrf
            @method('PUT')

            <div class="section-subtitle text-primary">Identitas Perusahaan</div>
            <div class="row">
                <div class="col-md-4 mb-4">
                    <label class="form-label text-muted">Kode Vendor</label>
                    <div class="input-group">
                        <span class="input-group-text"><i class="fas fa-id-badge"></i></span>
                        <input type="text" class="form-control form-control-with-icon" value="{{ $s->kd_vendor }}" disabled>
                    </div>
                </div>
                ...
                <div class="col-md-8 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="nm_vendor" class="form-control form-control-with-icon" 
                               value="{{ old('nm_vendor', $s->nm_vendor) }}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex gap-3">
                <button type="submit" class="btn btn-update flex-grow-1 shadow-sm">
                    <i class="fas fa-sync-alt me-2"></i> Perbarui Data Vendor
                </button>
